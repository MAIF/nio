...
trait TestUtilsPostgres
  ...
  protected lazy val nioComponents: NioSpecPostgres =
    new NioSpecPostgres(getContext, Some(authInfo))
  ...
  override def fakeApplication(): Application = {
    new NioTestLoaderPostgres(Some(authInfo)).load(getContext)
  }
