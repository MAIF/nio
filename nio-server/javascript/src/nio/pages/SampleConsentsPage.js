...
export class SampleConsentsPage extends Component {
  errorsMessage = [
    {key: "organisationKey.required", value: "L'identifiant de l'organisation est obligatoire."},
    {key: "userId.required", value: "L'identifiant de l'utilisateur est obligatoire."}
  ];
      ...
      <div className="row">
        ...
        <div className="col-md-12">
          <TextInput
            ...
            errorKey={"consentsSample.organisationKey.required"}
          />
          <TextInput
              ...
              this.state.newTemplate ?
                ...
                <h3>Récupération des consentements de l'utilisateur {
                  ...
                  <div className="btn btn-primary"
                       onClick={() => this.setState({user: {...this.state.templateUser}})}>Mettre à jour les consentements
              ...
              }
              {
                ...
                <div className="col-md-8">
                  <Moment locale="fr" parse="YYYY-MM-DDTHH:mm:ssZ"
                          format="DD/MM/YYYY HH:mm:ss">{this.state.user.lastUpdate}</Moment> (<Moment locale="fr"
...

        {
          ...
          <ConsentsPage groups={this.state.user.groups} user={this.state.user} tenant={this.props.tenant}
                        organisationKey={this.state.organisationKey} userId={this.state.userId} submitable={true}/>
        }
      </div>
    )
  }
