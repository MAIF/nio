...
These guidelines apply to all Nio projects living in the the `MAIF/nio` repository.
...
* [docs](https://github.com/MAIF/nio/docs): contains the Nio website, avoid modification as its generated
* [manual](https://github.com/MAIF/nio/manual): the nio user manual that will be generated with [Paradox](https://github.com/lightbend/paradox)
* [nio-server](https://github.com/MAIF/nio/nio-server): the nio server app
* [scripts](https://github.com/MAIF/nio/scripts): various scripts used by Travis and devs
...
1. To avoid duplicated effort, it might be good to check the [issue tracker](https://github.com/MAIF/nio/issues) and [existing pull requests](https://github.com/MAIF/nio/pulls) for existing work.
   - If there is no ticket yet, feel free to [create one](https://github.com/MAIF/nio/issues/new) to discuss the problem and the approach you want to take to solve it.
1. [Fork the project](https://github.com/MAIF/nio#fork-destination-box) on GitHub. You'll need to create a feature-branch for your work on your fork, as this way you'll be able to submit a pull request against the mainline Akka.
...
1. If it's a new feature, or a change of behaviour, document it on the [akka-docs](https://github.com/MAIF/nio/tree/master/manual), remember, an undocumented feature is not a feature.
...
You must add the dependency and its licence in https://github.com/MAIF/nio/blob/master/licences.md

## Documentation

if you add features to Nio, don't forget to modify the user manual, the swagger file and the clients too

* https://github.com/MAIF/nio/tree/master/manual/src/main/paradox
* https://github.com/MAIF/nio/blob/master/nio-server/public/swagger/swagger.json
* https://github.com/MAIF/nio/blob/master/nio-server/public/swagger/swagger.yaml


## Continuous integration

Every commit and PR to Nio is built by [Travis](https://travis-ci.org/MAIF/nio). Travis will also check your pull request to prevent merging code that does not build.